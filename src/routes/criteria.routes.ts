...
import { createCriteriaController, getAllCriteriaController, getCriteriaByIdController, getCriteriaBySemesterIdController } from '~/controllers/criteria.controller';
