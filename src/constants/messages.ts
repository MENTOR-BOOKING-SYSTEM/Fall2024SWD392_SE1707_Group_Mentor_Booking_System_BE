...
export const PROJECTS_MESSAGE = {
  ...
  CAN_NOT_SEND_MORE_PROJECT: 'No more projects can be submitted because the previous project is being processed and maximum of 3 projects can be submitted.',
